...
4. 合并所有数据并按日期排序
5. 保存为Parquet格式，便于AI训练时快速加载
6. 生成元数据文件（列信息、统计信息等）

输出：
- merged_data_v0.1.parquet: 合并后的完整数据
- data_metadata_v0.1.json: 元数据信息
- company_mapping_v0.1.json: 公司映射表
- processing_log_v0.1.txt: 处理日志
"""
