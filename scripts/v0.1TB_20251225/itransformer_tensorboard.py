...
# -*- coding: utf-8 -*-
"""
主训练脚本（集成TensorBoard）- iTransformer版本
版本: v0.1TB
日期: 20251225

整合所有模块，作为训练入口，支持TensorBoard可视化
使用iTransformer模型进行时间序列预测
"""
...
# ===== 默认训练数据路径（如需调整请修改此处） =====
DEFAULT_PREPROCESSED_DIR = project_root / "data" / "processed" / "preprocess_data_v0.5_20260109111857_500120"
...
def extract_version_number(config_version: str) -> str:
    ...
    Args:
        config_version: 配置版本号，如 'v0.1TB_20251225'
        
    Returns:
        版本号，如 'v0.1TB'
    """
    # 使用split分割，取第一部分（下划线前的版本号）
    # 例如: 'v0.1TB_20251225' -> 'v0.1TB'
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='训练iTransformer模型（集成TensorBoard）')
    parser.add_argument('--config_version', type=str, default='v0.1TB_20251225',
                        help='配置版本号')
    ...
    print("=" * 80)
    print("iTransformer 训练脚本 (集成TensorBoard)")
    print("=" * 80)
    ...
    if tb_enabled:
        ...
        # 使用完整的模型文件夹名称作为运行名称
        # 例如: itransformer_v0.1TB_20251226112038_20251225210740
