...
# -*- coding: utf-8 -*-
"""
主训练脚本（集成TensorBoard，支持mask）- TimeXer版本（双分支架构）
版本: v0.42
日期: 20260118
...
v0.42新增：完整的mask支持，自动排除空白数据（-1000）
"""
...
# 导入所需模块（使用v0.42_20260118版本的模型，v0.3_20260118版本的trainer，v0.3_20260119版本的数据(支持mmap)，v0.1版本的utils）
models_path = project_root / "src" / "models" / "v0.42_20260118"
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='训练TimeXer模型（双分支架构，交叉注意力融合，集成TensorBoard，支持mask）')
    parser.add_argument('--config_version', type=str, default='v0.42_20260118',
                        help='配置版本号')
    ...
    print("=" * 80)
    print("TimeXer 训练脚本 v0.42 (双分支 + 交叉注意力 + TensorBoard + Mask Support)")
    print("=" * 80)
