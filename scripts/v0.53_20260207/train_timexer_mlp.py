...
# -*- coding: utf-8 -*-
"""
主训练脚本 - TimeXer-MLP v0.53（Instance Normalization）
版本: v0.53
日期: 20260207

使用TimeXer-MLP双分支模型，集成TensorBoard，支持学习型Missing Embedding + Instance Normalization
v0.53新增：Instance Normalization + 反归一化，损失计算在原始尺度
"""
...
# 导入模块（使用v0.53模型，v0.2 trainer，v0.1数据和utils）
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='训练TimeXer-MLP模型 v0.53（Instance Normalization）')
    parser.add_argument('--config_version', type=str, default='v0.53_20260207',
                        help='配置版本号')
    ...
    print("=" * 80)
    print("TimeXer-MLP v0.53 训练脚本（Instance Normalization）")
    print("=" * 80)
